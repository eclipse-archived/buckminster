...
public class InvokeAction extends AbstractCSpecAction
{
	...
	private class ActionsDialog extends Dialog
	{
		...
		public void setErrorMessage(String errorMessage)
		{
			...
			{
				m_errorMessageText.setText(errorMessage == null
		...
		protected Control createDialogArea(Composite parent)
		{
			...
			m_viewer.setLabelProvider(new LabelProvider()
			{
				...
				{
					return element == null
							? "" : ((Attribute)element).getName(); //$NON-NLS-1$
				}
			});
	...
	protected void run(CSpec cspec, Shell shell)
	{
		...
		ActionsDialog dialog = new ActionsDialog(shell, Messages.actions_of + cspec.getName(), viableAttributes);

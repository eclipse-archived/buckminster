 ...
 *
 */
public class ExternalCommandBuilderEditor implements IBuilderEditor
{
	...
	{
		ExternalCommandBuilderEditorDialog dlg = new ExternalCommandBuilderEditorDialog(shell, project, builderName, args);

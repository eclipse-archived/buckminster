...
public interface ICache
{
	 ...
	 * </p>
	 * <p>
	 * A file that is placed in the cache must first meet two distinct conditions
	 * <ul>
	 * <li>The <code>remoteDigest</code> must be successfully retrieved</li>
	 * <li>The digest calculated on the content of the <code>remoteFile</code> during download must match the
	 * <code>remoteDigest</code></li>
	 * </ul>
	 * </p>
	 * <p>
	 * If a local copy of the digest is found in the cache and that local digest is not older then 30 seconds, it will
	 * be trusted and no connection attempt will be made to the remote source. In all other cases, the remote digest
	 * will be fetched and compared to the current local copy. A new copy of the <code>remoteFile</code> will be
	 * downloaded in case they don't match.
	 * </p>
	 * 
	 * @param remoteFile

...
/**
 * This is the action bar contributor for the Rmap model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class RmapActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
	...
	protected IAction showPropertiesViewAction = new Action(
			RmapEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
	{
		@Override
		public void run()
		{
	...
	protected IAction refreshViewerAction = new Action(
			RmapEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
	{
		@Override

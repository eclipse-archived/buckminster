...
{
	private static final String BUNDLE_NAME = "org.eclipse.buckminster.p4.messages"; //$NON-NLS-1$

	public static String client_already_exists;

	public static String default_can_only_be_used_with_import;

	public static String max_2_paths_allowed_for_AltRoots;

	public static String missing_environment_P4CLIENT;
	...
	public static String no_default_client_exists;

	public static String no_p4_servers_have_been_configured;

	public static String no_such_P4_server_0;

	public static String only_one_action_per_invocation_please;

	public static String only_UNC_paths_are_accepted;

	public static String overwrite_can_only_be_used_with_import;
	...
	public static String process_died_with_exit_code_0;
	...
	public static String weird_responds_from_p4_where_0;

	public static String tag_timestamp_and_change_number_are_mutually_exclusive;

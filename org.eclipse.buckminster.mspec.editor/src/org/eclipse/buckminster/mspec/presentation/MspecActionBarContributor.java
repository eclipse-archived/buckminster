...
/**
 * This is the action bar contributor for the Mspec model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MspecActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
	...
	protected IAction showPropertiesViewAction = new Action(
			MspecEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
	{
		@Override
		public void run()
		{
	...
	protected IAction refreshViewerAction = new Action(
			MspecEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
	{
		@Override

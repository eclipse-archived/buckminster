...
/**
 * This is the action bar contributor for the Mspec model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MspecActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(MspecEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(MspecEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	 ...
	 * @generated
	 */
	public MspecActionBarContributor() {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(MspecEditorPlugin.INSTANCE.getString("_UI_MspecEditor_menu"),
				"org.eclipse.buckminster.mspecMenuID");
		...
		//
		createChildMenuManager = new MenuManager(MspecEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(MspecEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("mspec-settings"));
		toolBarManager.add(new Separator("mspec-additions"));
	}
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(MspecEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(MspecEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

...
public class MavenExample {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(MavenPackage.eNS_URI, MavenPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.maven"));
				GroupAndArtifact root = MavenFactory.eINSTANCE.createGroupAndArtifact();

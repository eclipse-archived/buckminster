...
import org.eclipse.buckminster.rmap.psf.util.PsfAdapterFactory;
 ...
 * @generated
 */
public class PsfItemProviderAdapterFactory extends PsfAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable,
		...
		protected static class CreationSwitch extends CommonSwitch<Object> {
			...
			public Object caseDocumentation(Documentation object) {
				newChildDescriptors.add(createChildParameter(CommonPackage.Literals.DOCUMENTATION__MIXED,
						FeatureMapUtil.createEntry(RmapPackage.Literals.DOCUMENT_ROOT__PROVIDERS, PsfFactory.eINSTANCE.createPSFProvider())));
	...
	public static class RmapChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends RmapSwitch<Object> {
			...
			public Object caseDocumentRoot(EObject object) {
				newChildDescriptors
						.add(createChildParameter(RmapPackage.Literals.DOCUMENT_ROOT__PROVIDERS, PsfFactory.eINSTANCE.createPSFProvider()));
			...
			public Object caseSearchPath(SearchPath object) {
				newChildDescriptors.add(createChildParameter(RmapPackage.Literals.SEARCH_PATH__PROVIDERS, PsfFactory.eINSTANCE.createPSFProvider()));
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(PsfEditPlugin.INSTANCE, PsfPackage.eNS_URI);
	 ...
	 * {@link org.eclipse.buckminster.rmap.psf.PSFProvider} instances. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected PSFProviderItemProvider psfProviderItemProvider;
	 ...
	 * @generated
	 */
	public PsfItemProviderAdapterFactory() {
	 ...
	 * {@link org.eclipse.buckminster.rmap.psf.PSFProvider}. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createPSFProviderAdapter() {
		if (psfProviderItemProvider == null) {
			psfProviderItemProvider = new PSFProviderItemProvider(this);
		}

		return psfProviderItemProvider;
	}

...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.rmap.psf.PSFProvider} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PSFProviderItemProvider extends ProviderItemProvider implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	/**
	 * This returns PSFProvider.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PSFProvider"));
	}
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
	{
		if(itemPropertyDescriptors == null)
		{
			...
			addPsfFilePropertyDescriptor(object);
		}
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0
				? getString("_UI_PSFProvider_type")
				: getString("_UI_PSFProvider_type") + " " + label;
	}

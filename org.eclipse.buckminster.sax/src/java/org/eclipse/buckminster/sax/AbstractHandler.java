...
public abstract class AbstractHandler extends DefaultHandler {
	 ...
	 * This method returns <code>null</code> when the attribute is
	 ...
	 *             when the attribute is not null or empty and cannot be
	 *             compiled into a regular expression pattern.
	 */
	...
	/**
	 * Returns an attribute that is parsed into a URL. This method returns
	 * <code>null</code> when the attribute is <code>null</code> or an empty
	 * String.
	 * 
	 * @param attrs
	 *            The attribute container.
	 ...
	 * @throws SAXParseException
	 *             when the attribute is not null or empty and cannot be parsed
	 *             into a URL
	 */
	 ...
	 * <code>TAG</code> declared for the class of the instance that receives the
	 * call.
	 * 
	 ...
	 * @throws SAXParseException
	 *             when the attribute value cannot be compiled into a regular
	 *             expression pattern.
	 */

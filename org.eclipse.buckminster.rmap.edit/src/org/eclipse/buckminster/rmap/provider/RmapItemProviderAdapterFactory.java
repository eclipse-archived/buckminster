...
public class RmapItemProviderAdapterFactory extends RmapAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable,
	...
	public static class CommonChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends CommonSwitch<Object> {
			...
			public Object caseDocumentation(Documentation object) {
					...
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__MATCH,
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__GROUP,
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__NAME,
							 CommonFactory.eINSTANCE.createRxPattern())));
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__VERSION,
							 CommonFactory.eINSTANCE.createRxPattern())));
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__REVISION,
							 CommonFactory.eINSTANCE.createRxPattern())));
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__TIMESTAMP,
							 CommonFactory.eINSTANCE.createRxPattern())));
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__OS,
							 CommonFactory.eINSTANCE.createRxPattern())));
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__WS,
							 CommonFactory.eINSTANCE.createRxPattern())));
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__ARCH,
							 CommonFactory.eINSTANCE.createRxPattern())));
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__NL,
							 CommonFactory.eINSTANCE.createRxPattern())));
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__LOCATORS,
				...
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.DOCUMENTATION__MIXED,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__REDIRECTS,
			...
			@Override
			public Object caseRxAssembly(RxAssembly object) {
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.RX_ASSEMBLY__RX_PARTS_GROUP,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__MATCH,
							 CommonFactory.eINSTANCE.createRxPattern())));
			...
			public Object caseRxGroup(RxGroup object) {
				newChildDescriptors.add
					(createChildParameter
						(CommonPackage.Literals.RX_GROUP__RX_PARTS_GROUP,
						 FeatureMapUtil.createEntry
							(RmapPackage.Literals.DOCUMENT_ROOT__MATCH,
							 CommonFactory.eINSTANCE.createRxPattern())));
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(RmapEditPlugin.INSTANCE, RmapPackage.eNS_URI);
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.buckminster.rmap.BranchPoint}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.buckminster.rmap.Locator}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.buckminster.rmap.Provider}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.buckminster.rmap.Redirect}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.buckminster.rmap.Repository}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.buckminster.rmap.ResourceMap}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.buckminster.rmap.SearchPath}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.buckminster.rmap.Transform}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.buckminster.rmap.URIMatcher}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public void dispose() {
		...
		if (redirectItemProvider != null) redirectItemProvider.dispose();
		if (repositoryItemProvider != null) repositoryItemProvider.dispose();
		if (resourceMapItemProvider != null) resourceMapItemProvider.dispose();
		if (searchPathItemProvider != null) searchPathItemProvider.dispose();
		if (transformItemProvider != null) transformItemProvider.dispose();
		if (uriMatcherItemProvider != null) uriMatcherItemProvider.dispose();
		if (versionConverterItemProvider != null) versionConverterItemProvider.dispose();
	}

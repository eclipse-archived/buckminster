 ...
 * 
 * This content provider registers itself as a listener to change in the ITreeRootNode and refreshes the view when
 * events occur. A UI safe implementation of ITreeRootNode must be used.
 * 
 * @author Henrik Lindberg
 * 
 */
public abstract class TreeDataNodeContentProvider implements IStructuredContentProvider, ITreeContentProvider,
		ITreeDataListener
{

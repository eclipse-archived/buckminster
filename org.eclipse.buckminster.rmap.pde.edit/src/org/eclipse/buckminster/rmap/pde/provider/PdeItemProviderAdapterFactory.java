...
import org.eclipse.buckminster.rmap.pde.util.PdeAdapterFactory;
...
public class PdeItemProviderAdapterFactory extends PdeAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable,
		...
		protected static class CreationSwitch extends CommonSwitch<Object> {
			...
			public Object caseDocumentation(Documentation object) {
				newChildDescriptors.add(createChildParameter(CommonPackage.Literals.DOCUMENTATION__MIXED,
						FeatureMapUtil.createEntry(RmapPackage.Literals.DOCUMENT_ROOT__PROVIDERS, PdeFactory.eINSTANCE.createPDEMapProvider())));
		...
		protected static class CreationSwitch extends RmapSwitch<Object> {
			...
			public Object caseDocumentRoot(EObject object) {
				newChildDescriptors.add(createChildParameter(RmapPackage.Literals.DOCUMENT_ROOT__PROVIDERS,
						PdeFactory.eINSTANCE.createPDEMapProvider()));
			...
			public Object caseSearchPath(SearchPath object) {
				newChildDescriptors
						.add(createChildParameter(RmapPackage.Literals.SEARCH_PATH__PROVIDERS, PdeFactory.eINSTANCE.createPDEMapProvider()));
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(PdeEditPlugin.INSTANCE, PdePackage.eNS_URI);
	 ...
	 * {@link org.eclipse.buckminster.rmap.pde.PDEMapProvider} instances. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected PDEMapProviderItemProvider pdeMapProviderItemProvider;
	...
	public Adapter createPDEMapProviderAdapter() {
		if (pdeMapProviderItemProvider == null) {
			pdeMapProviderItemProvider = new PDEMapProviderItemProvider(this);
		}

		return pdeMapProviderItemProvider;
	}
	...
	public void dispose() {
		if (pdeMapProviderItemProvider != null)
			pdeMapProviderItemProvider.dispose();
	}

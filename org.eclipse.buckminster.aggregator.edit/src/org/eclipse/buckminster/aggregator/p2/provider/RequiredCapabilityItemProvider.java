	...
	protected void addSelectorsPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IRequiredCapability_selectors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IRequiredCapability_selectors_feature", "_UI_IRequiredCapability_type"),
				 P2Package.Literals.IREQUIRED_CAPABILITY__SELECTORS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

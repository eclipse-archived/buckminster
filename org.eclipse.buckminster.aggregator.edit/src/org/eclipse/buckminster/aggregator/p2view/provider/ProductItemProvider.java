	...
	protected void addDetailsPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Product_details_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Product_details_feature", "_UI_Product_type"),
				 P2viewPackage.Literals.PRODUCT__DETAILS,
				 true,
				 false,
				 true,
				 null,

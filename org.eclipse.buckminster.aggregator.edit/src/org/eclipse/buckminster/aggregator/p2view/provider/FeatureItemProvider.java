 ...
 * @generated
 */
public class FeatureItemProvider extends IUPresentationItemProvider implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feature_bundleContainer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feature_bundleContainer_feature", "_UI_Feature_type"),
				 P2viewPackage.Literals.FEATURE__BUNDLE_CONTAINER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDetailsPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feature_details_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feature_details_feature", "_UI_Feature_type"),
				 P2viewPackage.Literals.FEATURE__DETAILS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFeatureContainerPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feature_featureContainer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feature_featureContainer_feature", "_UI_Feature_type"),
				 P2viewPackage.Literals.FEATURE__FEATURE_CONTAINER,
				 true,
				 false,
				 true,
				 null,

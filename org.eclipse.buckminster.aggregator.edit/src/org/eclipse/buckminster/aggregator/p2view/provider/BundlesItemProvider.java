		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bundles_bundles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bundles_bundles_feature", "_UI_Bundles_type"),
				 P2viewPackage.Literals.BUNDLES__BUNDLES,
				 true,
				 false,
				 true,
				 null,

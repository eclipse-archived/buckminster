		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Products_products_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Products_products_feature", "_UI_Products_type"),
				 P2viewPackage.Literals.PRODUCTS__PRODUCTS,
				 true,
				 false,
				 true,
				 null,

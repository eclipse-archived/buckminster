...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.aggregator.InstallationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AggregatorPackage.Literals.INSTALLATION_UNIT__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AggregatorPackage.Literals.INSTALLATION_UNIT__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRepositoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstallationUnit_repository_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstallationUnit_repository_feature", "_UI_InstallationUnit_type"),
				 AggregatorPackage.Literals.INSTALLATION_UNIT__REPOSITORY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMappedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstallationUnit_mapped_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstallationUnit_mapped_feature", "_UI_InstallationUnit_type"),
				 AggregatorPackage.Literals.INSTALLATION_UNIT__MAPPED,
				 true,
				 false,
				 false,

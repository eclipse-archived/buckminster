...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.aggregator.Category} object. <!--
		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected Query getInstallableUnitQuery()
	{
		return new MatchQuery()
		{
			...
			{
				return "true".equalsIgnoreCase(((IInstallableUnit)candidate).getProperty(IInstallableUnit.PROP_TYPE_CATEGORY));
			}
		};
	}
}

		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_identifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_identifier_feature", "_UI_Category_type"),
				 AggregatorPackage.Literals.CATEGORY__IDENTIFIER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AggregatorPackage.Literals.CATEGORY__LABEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AggregatorPackage.Literals.CATEGORY__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AggregatorPackage.Literals.CATEGORY__FEATURES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMappedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_mapped_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_mapped_feature", "_UI_Category_type"),
				 AggregatorPackage.Literals.CATEGORY__MAPPED,
				 true,
				 false,
				 false,

...
public class ConfigurationItemProvider
	...
	protected void addArchiveFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_archiveFormat_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_archiveFormat_feature", "_UI_Configuration_type"),
				 AggregatorPackage.Literals.CONFIGURATION__ARCHIVE_FORMAT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		OperatingSystem labelValue = ((Configuration)object).getOperatingSystem();

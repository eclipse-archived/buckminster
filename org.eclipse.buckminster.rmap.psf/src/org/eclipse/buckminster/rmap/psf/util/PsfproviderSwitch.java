 ...
 * @generated
 */
public class PsfproviderSwitch<T>
{
	/**
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>PSF Provider</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>PSF Provider</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePSFProvider(PSFProvider object)
	{
		return null;
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		...
		{
			PSFProvider psfProvider = (PSFProvider)theEObject;
			T result = casePSFProvider(psfProvider);
			if(result == null)

...
public abstract class AdvancedWizardPage extends WizardPage
{
	...
	/**
	 * Page can change a default button (e.g. when "Cancel" is changed to "Done", "Done" can be set as a default
	 * button). If -1 is returned default button is not changed.
	 */
	...
	/**
	 * It's used for validation of the whole page after "Next" button is pressed. (e.g. don't want to login to a remote
	 * site each time isPageComplete() is called)
	 * 

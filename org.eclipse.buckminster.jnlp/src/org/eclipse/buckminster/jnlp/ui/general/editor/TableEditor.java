...
public class TableEditor<T> extends Composite
{
	...
	public TableEditor(Composite parent, ITable<T> table, Image windowImage, String windowTitle, Image wizardImage, int style)
	{
		super(parent, style);
		m_table = table;
	...
	private void newRow()
	{
		TableRowDialog<T> dialog =
			new TableRowDialog<T>(this.getShell(), m_windowImage, m_windowTitle, m_wizardImage, m_table, -1);
	...
	private void editRow()
	{
		TableRowDialog<T> dialog =
			new TableRowDialog<T>(
					this.getShell(), m_windowImage, m_windowTitle, m_wizardImage,

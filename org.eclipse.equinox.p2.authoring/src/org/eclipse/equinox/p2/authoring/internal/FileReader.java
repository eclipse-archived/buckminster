...
public class FileReader extends FileTransferJob implements IFileTransferListener
{
	...
	public InputStream read(URL url) throws CoreException, FileNotFoundException
	{
		...
		{
			throw P2AuthoringException.wrap(e);
		}
		...
		return new InputStream()
		{
			...
			private void checkException() throws IOException
			{
				...
				IOException e;
				Throwable t = P2AuthoringException.unwind(m_exception);
	...
	{
		IRetrieveFileTransferContainerAdapter adapter = P2AuthoringUIPlugin.getDefault().createRetrieveFileTransfer();
		m_exception = null;
		...
		if(m_exception != null)
		{
			...
			throw P2AuthoringException.wrap(m_exception);
		}
	}
}

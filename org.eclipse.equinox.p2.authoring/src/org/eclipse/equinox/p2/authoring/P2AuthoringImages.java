...
public class P2AuthoringImages
{
	...
	/**
	 * Returns an Image descriptor to a managed image descriptor. The user <i>must not</i> dispose of the
	 * created image.
	 * @param imageKey
	 * @return
	 */
	...
	/**
	 * Get the workbench when there is no other starting point.

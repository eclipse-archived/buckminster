 ...
 * <ul>
 *   <li>{@link org.eclipse.b3.beeLang.impl.PreConditionImpl#getAsserts <em>Asserts</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PreConditionImpl extends MinimalEObjectImpl.Container implements PreCondition
{
  ...
  {
    return BeeLangPackage.Literals.PRE_CONDITION;
  }
  ...
  public EList<AssertionExpression> getAsserts()
  {
    if (asserts == null)
    {
      asserts = new EObjectContainmentEList<AssertionExpression>(AssertionExpression.class, this, BeeLangPackage.PRE_CONDITION__ASSERTS);
    }
    return asserts;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BeeLangPackage.PRE_CONDITION__ASSERTS:

 ...
 * <ul>
 *   <li>{@link org.eclipse.b3.beeLang.impl.LiteralArrayImpl#getElement <em>Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralArrayImpl extends LiteralImpl implements LiteralArray
{
  ...
  {
    return BeeLangPackage.Literals.LITERAL_ARRAY;
  }
  ...
  public EList<Expression> getElement()
  {
    if (element == null)
    {
      element = new EObjectContainmentEList<Expression>(Expression.class, this, BeeLangPackage.LITERAL_ARRAY__ELEMENT);
    }
    return element;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BeeLangPackage.LITERAL_ARRAY__ELEMENT:

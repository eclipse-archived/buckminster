 ...
 * <ul>
 *   <li>{@link org.eclipse.b3.beeLang.impl.BuildUnitImpl#isSynchronized <em>Synchronized</em>}</li>
 ...
 *   <li>{@link org.eclipse.b3.beeLang.impl.BuildUnitImpl#getUnsetProperties <em>Unset Properties</em>}</li>
 *   <li>{@link org.eclipse.b3.beeLang.impl.BuildUnitImpl#getSetProperties <em>Set Properties</em>}</li>
...
public class BuildUnitImpl extends MinimalEObjectImpl.Container implements BuildUnit
{
  ...
  public void setSynchronized(boolean newSynchronized)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BeeLangPackage.BUILD_UNIT__SYNCHRONIZED, oldSynchronized, synchronized_));
  }
  ...
  public EList<String> getUnsetProperties()
  {
    ...
    {
      unsetProperties = new EDataTypeEList<String>(String.class, this, BeeLangPackage.BUILD_UNIT__UNSET_PROPERTIES);
    }
  ...
  public EList<StringProperty> getSetProperties()
  {
    ...
    {
      setProperties = new EObjectContainmentEList<StringProperty>(StringProperty.class, this, BeeLangPackage.BUILD_UNIT__SET_PROPERTIES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case BeeLangPackage.BUILD_UNIT__SET_PROPERTIES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BeeLangPackage.BUILD_UNIT__SYNCHRONIZED:
      ...
      case BeeLangPackage.BUILD_UNIT__UNSET_PROPERTIES:

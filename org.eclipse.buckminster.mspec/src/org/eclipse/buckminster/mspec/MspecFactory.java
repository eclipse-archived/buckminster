...
public interface MspecFactory extends EFactory
{
	...
	/**
	 * Returns a new object of class '<em>Materialization Directive</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Materialization Node</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Materialization Spec</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Unpack</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 

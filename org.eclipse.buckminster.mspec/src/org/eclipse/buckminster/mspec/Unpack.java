...
public interface Unpack extends EObject {
	 ...
	 * suffix to be assumed when a suffix cannot be derived from the resource
	 * locator appoints the remote resource. This suffix controls the choice of
	 * unpacker. <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Expand</b></em>' attribute. The default
	 * value is <code>"true"</code>. <!-- begin-user-doc --> <!-- end-user-doc
	 * --> <!-- begin-model-doc --> Indicates that the materializer should
	 * expand the artifact as part of the unpack. <!-- end-model-doc -->
	 * 

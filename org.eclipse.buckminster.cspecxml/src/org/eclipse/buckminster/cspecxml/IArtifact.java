 ...
 * <ul>
 * <li>{@link org.eclipse.buckminster.cspecxml.IArtifact#getGroup <em>Group</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IArtifact#getDefinitions <em>Definitions</em>}</li>
 ...
 * <li>{@link org.eclipse.buckminster.cspecxml.IArtifact#getFilter <em>Filter</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IArtifact#getPath1 <em>Path1</em>}</li>
...
public interface IArtifact extends IAttribute
{
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='path' namespace='##targetNamespace' group='#group:4'"
	 * @generated
	 */
	EList<IPath> getPath();

	/**
	 * Returns the value of the '<em><b>Path1</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Path1</em>' attribute isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='attribute' name='path'"
	 * @generated
	 */
	String getPath1();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IArtifact#getBase <em>Base</em>}' attribute. <!--
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IArtifact#getFilter <em>Filter</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IArtifact#getPath1 <em>Path1</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IArtifact#getType <em>Type</em>}' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value

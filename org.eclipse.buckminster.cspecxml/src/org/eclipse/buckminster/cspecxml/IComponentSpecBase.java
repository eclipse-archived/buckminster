...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Component Spec Base</b></em>'. <!-- end-user-doc
 * -->
 * 
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getDocumentation <em>Documentation</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getGroup <em>Group</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getDependencies <em>Dependencies</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getGenerators <em>Generators</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getArtifacts <em>Artifacts</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getGroups <em>Groups</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getActions <em>Actions</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getCategory <em>Category</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getComponentType <em>Component Type</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getFilter <em>Filter</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getProjectInfo <em>Project Info</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getShortDesc <em>Short Desc</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getVersionString <em>Version String</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getVersionType <em>Version Type</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface IComponentSpecBase extends EObject
{
	 ...
	 * {@link org.eclipse.buckminster.cspecxml.IActionsType}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 *        extendedMetaData="kind='element' name='actions' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	 ...
	 * {@link org.eclipse.buckminster.cspecxml.IArtifactsType}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='artifacts' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	EList<IArtifactsType> getArtifacts();

	/**
	 * Returns the value of the '<em><b>Category</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='attribute' name='category'"
	 * @generated
	 */
	String getCategory();
	 ...
	 * {@link org.eclipse.buckminster.cspecxml.IDependenciesType}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * {@link org.eclipse.buckminster.cspecxml.IGeneratorsType}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='groups' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	 ...
	 * @model dataType="org.eclipse.buckminster.model.common.URL" extendedMetaData="kind='attribute' name='projectInfo'"
	 * @generated
	 */
	URL getProjectInfo();
	 ...
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" extendedMetaData="kind='attribute' name='shortDesc'"
	 * @generated
	 */
	String getShortDesc();
	...
	/**
	 * Returns the value of the '<em><b>Version String</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Version String</em>' attribute isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Version Type</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getCategory <em>Category</em>}'
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getComponentType
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getDocumentation
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getFilter <em>Filter</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getProjectInfo
	 * <em>Project Info</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getShortDesc
	 * <em>Short Desc</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getVersionString
	 * <em>Version String</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IComponentSpecBase#getVersionType

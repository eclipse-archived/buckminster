 ...
 * <!-- begin-model-doc -->
 * 
 * A definition defines an attribute as something that is part of another attribute. A good example is a Java package
 * that is part of a jar file.<br/>
 ...
 * <ul>
 * <li>{@link org.eclipse.buckminster.cspecxml.IDefinitions#getDefine <em>Define</em>}</li>
 * </ul>
 * </p>
 * 
...
{
	/**
	 * Returns the value of the '<em><b>Define</b></em>' containment reference list. The list contents are of type
	 * {@link org.eclipse.buckminster.cspecxml.IAttribute}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Define</em>' containment reference list isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 

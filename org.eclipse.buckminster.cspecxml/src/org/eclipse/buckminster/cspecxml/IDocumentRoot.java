 ...
 * <ul>
 * <li>{@link org.eclipse.buckminster.cspecxml.IDocumentRoot#getMixed <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IDocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IDocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IDocumentRoot#getCspec <em>Cspec</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspecxml.IDocumentRoot#getCspecExtension <em>Cspec Extension</em>}</li>
 * </ul>
 * </p>
 * 
...
{
	/**
	 * Returns the value of the '<em><b>Cspec</b></em>' containment reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Cspec</em>' containment reference isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 *        extendedMetaData="kind='element' name='cspec' namespace='##targetNamespace'"
	 * @generated
	 */
	IComponentSpec getCspec();

	/**
	 * Returns the value of the '<em><b>Cspec Extension</b></em>' containment reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Cspec Extension</em>' containment reference isn't clear, there really should be more
	 * of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 * @return the value of the '<em>Cspec Extension</em>' containment reference.
	 ...
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='cspecExtension' namespace='##targetNamespace'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IDocumentRoot#getCspec <em>Cspec</em>}'
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspecxml.IDocumentRoot#getCspecExtension
	 * <em>Cspec Extension</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Cspec Extension</em>' containment reference.

 ...
 * <ul>
 * <li>{@link org.eclipse.buckminster.cspecxml.impl.PathImpl#getPath <em>Path</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class PathImpl extends EObjectImpl implements IPath
{
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch(featureID)
		{
		case ICSpecXMLPackage.PATH__PATH:
			return getPath();
		}
	...
	public void setPath(String newPath)
	{
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ICSpecXMLPackage.PATH__PATH, oldPath, path));
	}
	...
	{
		return ICSpecXMLPackage.Literals.PATH;
	}

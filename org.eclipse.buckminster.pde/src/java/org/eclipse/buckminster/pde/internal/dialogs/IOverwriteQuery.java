...
public interface IOverwriteQuery {
	...
	/**
	 * Return code indicating the entity should be overwritten, and all
	 * subsequent entities should be overwritten without prompting.
	 */
	 ...
	 * must run the query in a sync exec in the UI thread, if it needs to query
	 * the user.
	 * </p>
	 * 
	 * @param pathString

...
public interface IImportStructureProvider
{
	...
	/**
	 * Returns the contents of the specified structured element, or <code>null</code> if there is a problem determining
	...
	/**
	 * Returns a boolean indicating whether the passed structured element represents a container element (as opposed to
	 * a leaf element).
	 * 
	 * @return boolean
	 * @param element

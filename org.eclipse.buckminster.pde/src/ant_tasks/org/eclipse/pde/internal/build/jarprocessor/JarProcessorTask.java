/*******************************************************************************
 * THIS IS NOT FOR ECLIPSE 3.3. IT'S ALREADY THERE!!!
 * 
 ...
 * 	- 
 * 
 * Added as part of the Buckminster PDE build integration for Eclipse 3.2.x.
 * Do <b>not</b> use or move this class to Eclipse 3.3.x or above. It's already
 * included in the standard org.eclipse.pde.build bundle.
 */

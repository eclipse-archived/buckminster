...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.cspec.Generator} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addAttributePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Generator_attribute_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_Generator_attribute_feature", "_UI_Generator_type"),
				CspecPackage.Literals.GENERATOR__ATTRIBUTE, true, false, false,
	...
	protected void addComponentPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Generator_component_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_Generator_component_feature", "_UI_Generator_type"),
				CspecPackage.Literals.GENERATOR__COMPONENT, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.GENERATOR__GENERATES,
				CspecFactory.eINSTANCE.createCSpec()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.GENERATOR__GENERATES,
				CspecFactory.eINSTANCE.createCSpecExtension()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.GENERATOR__GENERATES,
				CommonFactory.eINSTANCE.createComponentIdentifier()));
	}

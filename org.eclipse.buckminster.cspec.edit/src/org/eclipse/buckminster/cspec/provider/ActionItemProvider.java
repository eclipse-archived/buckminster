...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.cspec.Action} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ActionItemProvider extends GroupItemProvider implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
	{
		...
		boolean qualify = childFeature == CspecPackage.Literals.ACTION__PROPERTIES
	...
	protected void addPatternPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Action_pattern_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_Action_pattern_feature", "_UI_Action_type"), CspecPackage.Literals.ACTION__PATTERN, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Prerequisites Alias feature. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	protected void addPrerequisitesAliasPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Action_prerequisitesAlias_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_Action_prerequisitesAlias_feature", "_UI_Action_type"),
				CspecPackage.Literals.ACTION__PREREQUISITES_ALIAS, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Product Alias feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addProductAliasPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Action_productAlias_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_Action_productAlias_feature", "_UI_Action_type"),
				CspecPackage.Literals.ACTION__PRODUCT_ALIAS, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Product File Count feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addProductFileCountPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Action_productFileCount_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_Action_productFileCount_feature", "_UI_Action_type"),
				CspecPackage.Literals.ACTION__PRODUCT_FILE_COUNT, true, false, false,
	...
	protected void addProductsPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Action_products_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_Action_products_feature", "_UI_Action_type"), CspecPackage.Literals.ACTION__PRODUCTS,
				true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Replacement feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addReplacementPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Action_replacement_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_Action_replacement_feature", "_UI_Action_type"),
				CspecPackage.Literals.ACTION__REPLACEMENT, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Up To Date Policy feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addUpToDatePolicyPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Action_upToDatePolicy_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_Action_upToDatePolicy_feature", "_UI_Action_type"),
				CspecPackage.Literals.ACTION__UP_TO_DATE_POLICY, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ACTION__PROPERTIES,
				CommonFactory.eINSTANCE.createPropertyConstant()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ACTION__ACTOR_PROPERTIES,
				CommonFactory.eINSTANCE.createPropertyConstant()));
		...
		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ACTION__PRODUCT,
				CspecFactory.eINSTANCE.createActionAttribute()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ACTION__PRODUCT,
				CspecFactory.eINSTANCE.createPathGroup()));

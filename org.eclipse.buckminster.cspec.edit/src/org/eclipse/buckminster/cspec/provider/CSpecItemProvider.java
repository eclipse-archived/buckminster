...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.cspec.CSpec} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class CSpecItemProvider extends ComponentIdentifierItemProvider implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0
				? getString("_UI_CSpec_type")
				: getString("_UI_CSpec_type") + " " + label;
	}
	...
	protected void addDocumentationPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_CSpec_documentation_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_CSpec_documentation_feature", "_UI_CSpec_type"),
				CspecPackage.Literals.CSPEC__DOCUMENTATION, true, true, false, null, null, null));
	}
	...
	protected void addFilterPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_CSpec_filter_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_CSpec_filter_feature", "_UI_CSpec_type"), CspecPackage.Literals.CSPEC__FILTER, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Project Info feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	protected void addShortDescPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_CSpec_shortDesc_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_CSpec_shortDesc_feature", "_UI_CSpec_type"), CspecPackage.Literals.CSPEC__SHORT_DESC,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	/**
	 * Creates an add command that is wrapped to return the correct non-modeled item, in place of the target supplier,
	 * as part of the affected objects.
	 */
	@Override
	...
	/**
	 * Creates a remove command that is wrapped to return the correct non-modeled item, in place of the target supplier,
	 * as part of the affected objects.
	 */
	@Override
	...
	/**
	 * Returns a wrapper for the given command that returns the correct non-modeled item, in place of the target
	 * supplier, as part of the affected objects.
	 */

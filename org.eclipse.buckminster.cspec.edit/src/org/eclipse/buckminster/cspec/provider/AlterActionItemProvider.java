 ...
 * {@link org.eclipse.buckminster.cspec.AlterAction} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class AlterActionItemProvider extends ActionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == CspecPackage.Literals.GROUP__PREREQUISITES
				...
				|| childFeature == CspecPackage.Literals.ACTION__PROPERTIES || childFeature == CspecPackage.Literals.ACTION__ACTOR_PROPERTIES
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_AlterAction_type") : getString("_UI_AlterAction_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ALTER_ACTION__REPLACE_PROPERTIES, CommonFactory.eINSTANCE
				.createPropertyConstant()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ALTER_ACTION__REPLACE_ACTOR_PROPERTIES, CommonFactory.eINSTANCE
				.createPropertyConstant()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ALTER_ACTION__REMOVE_PROPERTIES, CspecFactory.eINSTANCE.createRemove()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ALTER_ACTION__REMOVE_ACTOR_PROPERTIES, CspecFactory.eINSTANCE
				.createRemove()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ALTER_ACTION__REMOVE_PRODUCTS, CspecFactory.eINSTANCE.createRemove()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.ALTER_ACTION__REMOVE_PATHS, CspecFactory.eINSTANCE.createRemove()));
	}

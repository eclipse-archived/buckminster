...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.cspec.PathGroup} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PathGroupItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0
				? getString("_UI_PathGroup_type")
				: getString("_UI_PathGroup_type") + " " + label;
	}
	...
	protected void addBasePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PathGroup_base_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_PathGroup_base_feature", "_UI_PathGroup_type"), CspecPackage.Literals.PATH_GROUP__BASE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Paths feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addPathsPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PathGroup_paths_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_PathGroup_paths_feature", "_UI_PathGroup_type"), CspecPackage.Literals.PATH_GROUP__PATHS,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

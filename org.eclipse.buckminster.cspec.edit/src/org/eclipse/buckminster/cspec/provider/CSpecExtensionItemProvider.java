...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.cspec.CSpecExtension} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class CSpecExtensionItemProvider extends CSpecItemProvider implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	/**
	 * This returns CSpecExtension.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0
				? getString("_UI_CSpecExtension_type")
				: getString("_UI_CSpecExtension_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.CSPEC_EXTENSION__ATTRIBUTE_ALTERATIONS,
				CspecFactory.eINSTANCE.createAlterArtifact()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.CSPEC_EXTENSION__ATTRIBUTE_ALTERATIONS,
				CspecFactory.eINSTANCE.createAlterGroup()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.CSPEC_EXTENSION__ATTRIBUTE_ALTERATIONS,
				CspecFactory.eINSTANCE.createAlterAction()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.CSPEC_EXTENSION__RENAME_ATTRIBUTES,
				CspecFactory.eINSTANCE.createRename()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.CSPEC_EXTENSION__REMOVE_DEPENDENCIES,
				CspecFactory.eINSTANCE.createRemove()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.CSPEC_EXTENSION__REMOVE_GENERATORS,
				CspecFactory.eINSTANCE.createRemove()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.CSPEC_EXTENSION__REPLACE_GENERATORS,
				CspecFactory.eINSTANCE.createGenerator()));

		newChildDescriptors.add(createChildParameter(CspecPackage.Literals.CSPEC_EXTENSION__REPLACE_DEPENDENCIES,
				CommonFactory.eINSTANCE.createComponentRequest()));
	}

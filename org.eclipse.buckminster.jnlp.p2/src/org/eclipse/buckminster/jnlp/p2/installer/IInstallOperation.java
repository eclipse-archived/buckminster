...
/**
 * The operation that will perform the install. This interface exists to allow the install advisor to act as the
 * runnable context for the install, handling progress monitoring and cancelation.
 * <p>
...
public interface IInstallOperation
{
	 ...
	 * 
	 * @param monitor
	 *            the monitor to be used for reporting progress and responding to cancelation, or <code>null</code> if
	 *            progress reporting and cancelation are not desired.

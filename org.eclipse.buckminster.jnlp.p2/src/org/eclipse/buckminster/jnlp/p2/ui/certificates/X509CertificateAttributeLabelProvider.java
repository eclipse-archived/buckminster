 ...
 * <p>
 * Label provider for a 2 column table that shows the attributes (fields) in an X509 digital certificate. See <a
 * href="http://java.sun.com/j2se/1.4.2/docs/api/java/security/cert/X509Certificate.html"> X509Certificate </a>
 * <p>
 * The first column is the Attribute name and the second column is the string representation of the attribute's value.
 * <p>

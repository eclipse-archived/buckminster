...
public interface MavenFactory extends EFactory
{
	...
	/**
	 * Returns a new object of class '<em>Group And Artifact</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Map Entry</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Mappings</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 

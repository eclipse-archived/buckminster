 ...
 * <ul>
 * <li>{@link org.eclipse.buckminster.cspec.Group#getPrerequisites <em>Prerequisites</em>}</li>
...
public interface Group extends Attribute
{
	 ...
	 * type {@link org.eclipse.buckminster.cspec.Prerequisite}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Rebase</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Rebase</em>' containment reference isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.cspec.Group#getRebase <em>Rebase</em>}' attribute. <!--

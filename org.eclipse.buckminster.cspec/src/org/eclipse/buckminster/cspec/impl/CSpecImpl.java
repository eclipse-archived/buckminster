...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>CSpec</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.buckminster.cspec.impl.CSpecImpl#getDependencies <em>Dependencies</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspec.impl.CSpecImpl#getGenerators <em>Generators</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspec.impl.CSpecImpl#getAttributes <em>Attributes</em>}</li>
 * <li>{@link org.eclipse.buckminster.cspec.impl.CSpecImpl#getDocumentation <em>Documentation</em>}</li>
...
public class CSpecImpl extends ComponentIdentifierImpl implements CSpec
{
	...
	public NotificationChain basicSetDocumentation(Documentation newDocumentation, NotificationChain msgs)
	{
		...
		if(eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CspecPackage.CSPEC__DOCUMENTATION, oldDocumentation, newDocumentation);
			if(msgs == null)
				msgs = notification;
			else
	...
	public EList<Attribute> getAttributes()
	{
		if(attributes == null)
		{
			attributes = new EObjectContainmentWithInverseEList<Attribute>(Attribute.class, this,
					CspecPackage.CSPEC__ATTRIBUTES, CspecPackage.ATTRIBUTE__CSPEC);
		}
		return attributes;
	}
	...
	public EList<ComponentRequest> getDependencies()
	{
		...
		{
			dependencies = new EObjectContainmentEList<ComponentRequest>(ComponentRequest.class, this,
	...
	public EList<Generator> getGenerators()
	{
		if(generators == null)
		{
			generators = new EObjectContainmentWithInverseEList<Generator>(Generator.class, this,
					CspecPackage.CSPEC__GENERATORS, CspecPackage.GENERATOR__CSPEC);
		}
		return generators;
	}
		...
		if(newDocumentation != documentation)
		{
			...
			if(documentation != null)
				msgs = ((InternalEObject)documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- CspecPackage.CSPEC__DOCUMENTATION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CspecPackage.CSPEC__DOCUMENTATION, newDocumentation,
					newDocumentation));
	}
	...
	public void setProjectInfo(URL newProjectInfo)
	{
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CspecPackage.CSPEC__PROJECT_INFO, oldProjectInfo,
					projectInfo));
	}
	...
	public void setShortDesc(String newShortDesc)
	{
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CspecPackage.CSPEC__SHORT_DESC, oldShortDesc,
					shortDesc));
	}

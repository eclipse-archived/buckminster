 ...
 * <ul>
 * <li>{@link org.eclipse.buckminster.cspec.impl.AlterAttributeImpl#getCspecext
 * <em>Cspecext</em>}</li>
 * </ul>
 * </p>
 * 
...
public abstract class AlterAttributeImpl extends EObjectImpl implements AlterAttribute {
	...
	public void setCspecext(CSpecExtension newCspecext) {
		if (newCspecext != eInternalContainer() || (eContainerFeatureID() != CspecPackage.ALTER_ATTRIBUTE__CSPECEXT && newCspecext != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CspecPackage.ALTER_ATTRIBUTE__CSPECEXT, newCspecext, newCspecext));
	}

...
public interface IResolverFactory extends IBuckminsterExtension
{
	...
	/**
	 * Returns the priority for the resolver. The priority determines the
	 * order in which the resolver will be placed into the active resolver
	 * list. A negative value indicates that the resolver is
	 * optional and must be added manually. The resolver with the value
	 * zero will be placed first in the list.

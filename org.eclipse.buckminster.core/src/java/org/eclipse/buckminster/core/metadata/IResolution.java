...
public interface IResolution extends IFileInfo
{
	...
	/**
	 * If a branch or tag was involved when this resolution was found, that branch or
	 * tag will be returned by this method.
	...
	/**
	 * The repository URI used in conjunction with the reader type when materializing this
	 * resolution.
	...
	/**
	 * An additional filter that a provider or other mechanism can assing to the resolution.
	 * This filter is involved when resolving dependencies against this resolution.
	...
	/**
	 * Returns true if the component should be unpacked after it has been materialized. The
	 * semantics of this attribute is determined by the materializer but it will typcially
	 * mean unzipping or unjaring the file.
	 *

 ...
 * however not limited to the OSGi syntax.
 * </p>
 * 
 * <p>
 * A version designator can appoint an explicit version or a range of versions. The range might be infinite and its
 * bounds might be included or excluded in the range.
 * </p>
 * 
...
public interface IVersionDesignator
{
	...
	{
		/**
		 * This instance designates all versions of another designator and then some.
		 */
		Contains,

		/**
		 * The other designator designates all versions of this instance and then some.
		 */
		ContainedBy,
		...
		/**
		 * The lower versions designated by this instance intersects with the higher versions designated by another
		 * designator but neither contain the other completely.
		 */
		IntersectLow,

		/**
		 * The higher versions designated by this instance intersects with the lower versions designated by another
		 * designator but neither contain the other completely.
		 */
		IntersectHigh,
	 ...
	 * 
	 * @param designator
	 *            The designator to compare with
	...
	/**
	 * Merge the two designators so that a new designator is created that will reflect the intesecting range.
	 * 
	 * @param that

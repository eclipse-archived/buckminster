...
import org.eclipse.buckminster.core.internal.version.AbstractVersion;

/**
 * @author Thomas Hallgren
 */
public class TripletVersion extends AbstractVersion
{
	...
	public TripletVersion(IVersionType type, int major, int minor, int micro, String qualifier)
	{
		super(type);
		m_major = major;
		m_minor = minor;
	...
	public boolean equals(Object o)
	{
		...
		if(!(o instanceof TripletVersion))
			return false;
		TripletVersion that = (TripletVersion)o;
	...
	/**
	 * Appends the string representation of this version identifier. The format of the version
	 * string will be <code>major.minor.micro.qualifier</code>. The <code>.qualifier</code> is
	 * not printed if the <code>qualifier</code> is null. The <code>.micro</code> is not printed
	 * if <code>micro</code> is zero. The <code>.mini</code> is not printed if <code>mini</code>
	 * and <code>micro</code> are both zero.
	 */

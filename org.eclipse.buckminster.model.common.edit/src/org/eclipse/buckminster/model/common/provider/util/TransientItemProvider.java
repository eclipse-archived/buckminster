...
/**
 * This class is intended as the super class of non-model intermediary views
 * added to the model. This is especially useful in scenarios where entity A has
 * several 0..* dependencies and instead of just having lots of objects directly
 * A, you want a group view for each dependency.
 * 
 * See chapter 19.2.3 in the EMF book for more info.
 */
public abstract class TransientItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider,
	...
	@Override
	public Command createCommand(final Object object, final EditingDomain domain, Class<? extends Command> commandClass,

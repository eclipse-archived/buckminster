...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.model.common.RxGroup} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class RxGroupItemProvider extends RxPartItemProvider implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0
				? getString("_UI_RxGroup_type")
				: getString("_UI_RxGroup_type") + " " + label;
	}

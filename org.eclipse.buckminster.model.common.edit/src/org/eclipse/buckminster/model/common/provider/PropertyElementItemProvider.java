...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.model.common.PropertyElement} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PropertyElementItemProvider extends PropertyItemProvider implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(createChildParameter(CommonPackage.Literals.PROPERTY_ELEMENT__CONSTANT,
				CommonFactory.eINSTANCE.createConstant()));

		newChildDescriptors.add(createChildParameter(CommonPackage.Literals.PROPERTY_ELEMENT__FORMAT,
				CommonFactory.eINSTANCE.createFormat()));

		newChildDescriptors.add(createChildParameter(CommonPackage.Literals.PROPERTY_ELEMENT__PROPERTY_REF,
				CommonFactory.eINSTANCE.createPropertyRef()));

		newChildDescriptors.add(createChildParameter(CommonPackage.Literals.PROPERTY_ELEMENT__REPLACE,
				CommonFactory.eINSTANCE.createReplace()));

		newChildDescriptors.add(createChildParameter(CommonPackage.Literals.PROPERTY_ELEMENT__TO_LOWER,
				CommonFactory.eINSTANCE.createToLower()));

		newChildDescriptors.add(createChildParameter(CommonPackage.Literals.PROPERTY_ELEMENT__TO_UPPER,

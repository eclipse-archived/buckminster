 ...
 * @generated
 */
public class ComponentRequestItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_ComponentRequest_id_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_ComponentRequest_id_feature", "_UI_ComponentRequest_type"),
				CommonPackage.Literals.COMPONENT_REQUEST__ID, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_ComponentRequest_type_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_ComponentRequest_type_feature", "_UI_ComponentRequest_type"),
				CommonPackage.Literals.COMPONENT_REQUEST__TYPE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

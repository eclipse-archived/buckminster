 ...
 * {@link org.eclipse.buckminster.rmap.maven.Scope} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ScopeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider,
	...
	protected void addExcludePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_Scope_exclude_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Scope_exclude_feature", "_UI_Scope_type"), MavenPackage.Literals.SCOPE__EXCLUDE,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_Scope_name_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Scope_name_feature", "_UI_Scope_type"), MavenPackage.Literals.SCOPE__NAME, true,

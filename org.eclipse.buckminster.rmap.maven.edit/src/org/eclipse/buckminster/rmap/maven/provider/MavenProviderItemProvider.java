...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.rmap.maven.MavenProvider} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MavenProviderItemProvider extends ProviderItemProvider implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0
				? getString("_UI_MavenProvider_type")
				: getString("_UI_MavenProvider_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(createChildParameter(MavenPackage.Literals.MAVEN_PROVIDER__MAPPINGS,
				MavenFactory.eINSTANCE.createMappings()));
	}

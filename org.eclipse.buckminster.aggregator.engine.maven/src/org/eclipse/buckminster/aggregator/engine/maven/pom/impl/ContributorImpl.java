 ...
 * <ul>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.impl.ContributorImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.impl.ContributorImpl#getEmail <em>Email</em>}</li>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.impl.ContributorImpl#getUrl <em>Url</em>}</li>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.impl.ContributorImpl#getOrganization <em>Organization
 * </em>}</li>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.impl.ContributorImpl#getOrganizationUrl <em>
 * Organization Url</em>}</li>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.impl.ContributorImpl#getRoles <em>Roles</em>}</li>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.impl.ContributorImpl#getTimezone <em>Timezone</em>}</li>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.impl.ContributorImpl#getProperties <em>Properties
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class ContributorImpl extends EObjectImpl implements Contributor
{
	...
	/**
	 * The cached value of the '{@link #getRoles() <em>Roles</em>}' containment reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getRoles()
	 * @generated
	...
	public void setOrganization(String newOrganization)
	{
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.CONTRIBUTOR__ORGANIZATION,
		...
		if(newProperties != properties)
		{
			...
			if(properties != null)
				msgs = ((InternalEObject)properties).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PomPackage.CONTRIBUTOR__PROPERTIES, null, msgs);
		...
		if(newRoles != roles)
		{
			...
			if(roles != null)
				msgs = ((InternalEObject)roles).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PomPackage.CONTRIBUTOR__ROLES, null, msgs);
			if(newRoles != null)

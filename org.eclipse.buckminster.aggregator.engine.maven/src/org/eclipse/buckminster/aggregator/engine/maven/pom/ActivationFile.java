 ...
 * 
 * This is the file specification used to activate the profile. The missing value will be the location of a file that
 * needs to exist, and if it doesn't the profile will be activated. On the other hand exists will test for the existence
 * of the file and if it is there the profile will be activated.
 * 
 * <!-- end-model-doc -->
 * 
 * <p>
 ...
 * <ul>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.ActivationFile#getMissing <em>Missing</em>}</li>
 * <li>{@link org.eclipse.buckminster.aggregator.engine.maven.pom.ActivationFile#getExists <em>Exists</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.buckminster.aggregator.engine.maven.pom.PomPackage#getActivationFile()
...
public interface ActivationFile extends EObject
{
	 ...
	 * @see org.eclipse.buckminster.aggregator.engine.maven.pom.PomPackage#getActivationFile_Exists()
	 ...
	 * @see org.eclipse.buckminster.aggregator.engine.maven.pom.PomPackage#getActivationFile_Missing()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.aggregator.engine.maven.pom.ActivationFile#getExists
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.aggregator.engine.maven.pom.ActivationFile#getMissing

...
public class WorkspaceBind extends Task {
	...
	public void execute() throws BuildException {
		...
		if (!projectDir.isDirectory())
			throw new BuildException(projectDir + " is not a directory", this.getLocation());

		WorkspaceBindTask executor = new WorkspaceBindTask(projectDir);
		try {
			executor.execute();
		} catch (Exception e) {
	 ...
	 * 
	 * @param An
	 *            absolute path denoting the project folder.
	 */

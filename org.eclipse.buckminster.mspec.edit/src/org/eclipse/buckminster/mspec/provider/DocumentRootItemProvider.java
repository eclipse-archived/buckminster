...
public class DocumentRootItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider,
	...
	protected void addMspecPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_DocumentRoot_mspec_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_DocumentRoot_mspec_feature", "_UI_DocumentRoot_type"), MspecPackage.Literals.DOCUMENT_ROOT__MSPEC, true, false, false,
				null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(MspecPackage.Literals.DOCUMENT_ROOT__PROPERTY, CommonFactory.eINSTANCE.createPropertyConstant()));

		newChildDescriptors.add(createChildParameter(MspecPackage.Literals.DOCUMENT_ROOT__PROPERTY_ELEMENT, CommonFactory.eINSTANCE

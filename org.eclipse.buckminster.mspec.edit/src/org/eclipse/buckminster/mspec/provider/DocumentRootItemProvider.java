		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if(childrenFeatures == null)
		{
			...
			childrenFeatures.add(MspecPackage.Literals.DOCUMENT_ROOT__PROPERTY);
			childrenFeatures.add(MspecPackage.Literals.DOCUMENT_ROOT__PROPERTY_ELEMENT);
	...
	public void notifyChanged(Notification notification)
	{
		...
		{
		case MspecPackage.DOCUMENT_ROOT__PROPERTY:
		case MspecPackage.DOCUMENT_ROOT__PROPERTY_ELEMENT:
	...
	/**
	 * This adds a property descriptor for the Mspec feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addMspecPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_DocumentRoot_mspec_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_DocumentRoot_mspec_feature", "_UI_DocumentRoot_type"),
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(createChildParameter(MspecPackage.Literals.DOCUMENT_ROOT__PROPERTY,
				CommonFactory.eINSTANCE.createPropertyConstant()));

		newChildDescriptors.add(createChildParameter(MspecPackage.Literals.DOCUMENT_ROOT__PROPERTY_ELEMENT,
				CommonFactory.eINSTANCE.createPropertyElement()));

		newChildDescriptors.add(createChildParameter(MspecPackage.Literals.DOCUMENT_ROOT__MSPEC,
				MspecFactory.eINSTANCE.createMaterializationSpec()));
	}

...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.mspec.MaterializationNode} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MaterializationNodeItemProvider extends MaterializationDirectiveItemProvider implements
		...
		IItemPropertySource
{
	...
	/**
	 * This returns MaterializationNode.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	/**
	 * This adds a property descriptor for the Binding Name Pattern feature. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	protected void addBindingNamePatternPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_MaterializationNode_bindingNamePattern_feature"), getString(
						"_UI_PropertyDescriptor_description", "_UI_MaterializationNode_bindingNamePattern_feature",
						"_UI_MaterializationNode_type"),
				MspecPackage.Literals.MATERIALIZATION_NODE__BINDING_NAME_PATTERN, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Binding Name Replacement feature. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addBindingNameReplacementPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MaterializationNode_bindingNameReplacement_feature"), getString(
						"_UI_PropertyDescriptor_description", "_UI_MaterializationNode_bindingNameReplacement_feature",
						"_UI_MaterializationNode_type"),
				MspecPackage.Literals.MATERIALIZATION_NODE__BINDING_NAME_REPLACEMENT, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	/**
	 * This adds a property descriptor for the Exclude feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addExcludePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MaterializationNode_exclude_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_MaterializationNode_exclude_feature", "_UI_MaterializationNode_type"),
				MspecPackage.Literals.MATERIALIZATION_NODE__EXCLUDE, true, false, false,
	...
	protected void addFilterPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MaterializationNode_filter_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_MaterializationNode_filter_feature", "_UI_MaterializationNode_type"),
				MspecPackage.Literals.MATERIALIZATION_NODE__FILTER, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Leaf Artifact feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addLeafArtifactPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MaterializationNode_leafArtifact_feature"), getString(
						"_UI_PropertyDescriptor_description", "_UI_MaterializationNode_leafArtifact_feature",
						"_UI_MaterializationNode_type"), MspecPackage.Literals.MATERIALIZATION_NODE__LEAF_ARTIFACT,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addNamePatternPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MaterializationNode_namePattern_feature"), getString(
						"_UI_PropertyDescriptor_description", "_UI_MaterializationNode_namePattern_feature",
						"_UI_MaterializationNode_type"), MspecPackage.Literals.MATERIALIZATION_NODE__NAME_PATTERN,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addResourcePathPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MaterializationNode_resourcePath_feature"), getString(
						"_UI_PropertyDescriptor_description", "_UI_MaterializationNode_resourcePath_feature",
						"_UI_MaterializationNode_type"), MspecPackage.Literals.MATERIALIZATION_NODE__RESOURCE_PATH,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Unpack feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addUnpackPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MaterializationNode_unpack_feature"), getString("_UI_PropertyDescriptor_description",

...
/**
 * This is the item provider adapter for a {@link org.eclipse.buckminster.mspec.MaterializationDirective} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MaterializationDirectiveItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	/**
	 * This returns MaterializationDirective.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0
				? getString("_UI_MaterializationDirective_type")
				: getString("_UI_MaterializationDirective_type") + " " + label;
	}
	...
	/**
	 * This adds a property descriptor for the Conflict Resolution feature. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	protected void addConflictResolutionPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_MaterializationDirective_conflictResolution_feature", "_UI_MaterializationDirective_type"),
				MspecPackage.Literals.MATERIALIZATION_DIRECTIVE__CONFLICT_RESOLUTION, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Install Location feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addInstallLocationPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_MaterializationDirective_installLocation_feature"), getString(
						"_UI_PropertyDescriptor_description", "_UI_MaterializationDirective_installLocation_feature",
						"_UI_MaterializationDirective_type"),
				MspecPackage.Literals.MATERIALIZATION_DIRECTIVE__INSTALL_LOCATION, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	/**
	 * This adds a property descriptor for the Workspace Location feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addWorkspaceLocationPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_MaterializationDirective_workspaceLocation_feature"), getString(
						"_UI_PropertyDescriptor_description", "_UI_MaterializationDirective_workspaceLocation_feature",
						"_UI_MaterializationDirective_type"),
				MspecPackage.Literals.MATERIALIZATION_DIRECTIVE__WORKSPACE_LOCATION, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(createChildParameter(MspecPackage.Literals.MATERIALIZATION_DIRECTIVE__PROPERTY_GROUP,
				FeatureMapUtil.createEntry(MspecPackage.Literals.DOCUMENT_ROOT__PROPERTY,
						CommonFactory.eINSTANCE.createPropertyConstant())));

		newChildDescriptors.add(createChildParameter(MspecPackage.Literals.MATERIALIZATION_DIRECTIVE__PROPERTY_GROUP,
				FeatureMapUtil.createEntry(MspecPackage.Literals.DOCUMENT_ROOT__PROPERTY_ELEMENT,

...
public class P2viewActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
	 ...
	 * @generated
	 */
	public P2viewActionBarContributor()
	{
	...
	public void contributeToMenu(IMenuManager menuManager)
	{
		...
		IMenuManager submenuManager = new MenuManager(AggregatorEditorPlugin.INSTANCE.getString("_UI_P2viewEditor_menu"), "org.eclipse.buckminster.aggregator.p2viewMenuID");
	...
	{
		toolBarManager.add(new Separator("p2view-settings"));
		toolBarManager.add(new Separator("p2view-additions"));
	}

 ...
 * <li>{@link org.eclipse.buckminster.rmap.Provider#getMatchers <em>Matchers</em>}</li>
...
public interface Provider extends Properties
{
	...
	/**
	 * Returns the value of the '<em><b>Component Types Attr</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Component Types Attr</em>' attribute isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model volatile="true" derived="true" extendedMetaData="name='componentTypes' kind='attribute'"
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Matchers</b></em>' containment reference list. The list contents are of type
	 * {@link org.eclipse.buckminster.rmap.URIMatcher}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Matchers</em>' containment reference list isn't clear, there really should be more of
	 * a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model containment="true" extendedMetaData="name='matcher' kind='element' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<URIMatcher> getMatchers();

	/**
	 * Returns the value of the '<em><b>Reader Type</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Reader Type</em>' attribute isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Resolution Filter</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Resolution Filter</em>' attribute isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Uri</b></em>' containment reference. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model containment="true" required="true" extendedMetaData="namespace='##targetNamespace' kind='element'"
	 * @generated
	 */
	Format getUri();

	/**
	 * Returns the value of the '<em><b>Version Converter</b></em>' containment reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Version Converter</em>' containment reference isn't clear, there really should be more
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.rmap.Provider#getComponentTypesAttr
	 * <em>Component Types Attr</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Component Types Attr</em>' attribute.
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.rmap.Provider#getDocumentation <em>Documentation</em>}'
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.rmap.Provider#getReaderType <em>Reader Type</em>}'
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.rmap.Provider#getResolutionFilter
	 * <em>Resolution Filter</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.rmap.Provider#getVersionConverter
	 * <em>Version Converter</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Version Converter</em>' containment reference.

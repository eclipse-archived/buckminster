...
public class RmapPackageImpl extends EPackageImpl implements RmapPackage
{
	...
	{
		return (EReference)uriMatcherEClass.getEStructuralFeatures().get(1);
	}
	...
	public void initializePackageContents()
	{
		...
		initEAttribute(getRedirect_Href(), theCommonPackage.getURL(), "href", null, 1, 1, Redirect.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getURIMatcher_Base(), ecorePackage.getEString(), "base", null, 0, 1, URIMatcher.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getURIMatcher_RxParts(), theCommonPackage.getRxPart(), null, "rxParts", null, 0, -1,
	...
	protected void createExtendedMetaDataAnnotations()
	{
		...
		addAnnotation(getURIMatcher_RxParts(), source, new String[] { "name", "rxPart", "kind", "element", "namespace",
				"##targetNamespace" });
	}

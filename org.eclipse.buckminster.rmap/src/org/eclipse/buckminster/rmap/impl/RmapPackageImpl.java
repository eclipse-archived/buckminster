...
public class RmapPackageImpl extends EPackageImpl implements RmapPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getLocator_SearchPath(), this.getSearchPath(), null, "searchPath", null, 1, 1, Locator.class, !IS_TRANSIENT, !IS_VOLATILE,
		...
		initEReference(getResourceMap_Locators(), this.getLocator(), null, "locators", null, 0, -1, ResourceMap.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceMap_Redirects(), this.getRedirect(), null, "redirects", null, 0, -1, ResourceMap.class, !IS_TRANSIENT,
		...
		initEAttribute(getProvider_ComponentTypes(), ecorePackage.getEString(), "componentTypes", "", 0, -1, Provider.class, IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProvider_ComponentTypesAttr(), ecorePackage.getEString(), "componentTypesAttr", null, 0, 1, Provider.class, !IS_TRANSIENT,
				IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProvider_Mutable(), ecorePackage.getEBoolean(), "mutable", "true", 0, 1, Provider.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProvider_ResolutionFilter(), ecorePackage.getEString(), "resolutionFilter", null, 0, 1, Provider.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProvider_Uri(), theCommonPackage.getFormat(), null, "uri", null, 1, 1, Provider.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProvider_Matchers(), this.getURIMatcher(), null, "matchers", null, 0, -1, Provider.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVersionConverter_Type(), ecorePackage.getEString(), "type", null, 1, 1, VersionConverter.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getURIMatcher_Base(), ecorePackage.getEString(), "base", null, 0, 1, URIMatcher.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getURIMatcher_RxPartsGroup(), ecorePackage.getEFeatureMapEntry(), "rxPartsGroup", null, 1, -1, URIMatcher.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getURIMatcher_RxParts(), theCommonPackage.getRxPart(), null, "rxParts", null, 1, -1, URIMatcher.class, IS_TRANSIENT,
				IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(propertiesEClass, Properties.class, "Properties", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProperties_Properties(), theCommonPackage.getPropertyConstant(), null, "properties", null, 0, -1, Properties.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProperties_PropertyElements(), theCommonPackage.getPropertyElement(), null, "propertyElements", null, 0, -1,
				Properties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(getResourceMap_Locators(), source, new String[] { "name", "locator", "namespace", "##targetNamespace", "kind", "element" });
		addAnnotation(getResourceMap_Redirects(), source, new String[] { "name", "redirect", "namespace", "##targetNamespace", "kind", "element" });
		...
		addAnnotation(getResourceMap_Documentation(), source, new String[] { "name", "documentation", "kind", "element", "namespace",
				"##targetNamespace" });
		addAnnotation(getProvider_ComponentTypesAttr(), source, new String[] { "name", "componentTypes", "kind", "attribute" });
		...
		addAnnotation(getProvider_Matchers(), source, new String[] { "name", "matcher", "kind", "element", "namespace", "##targetNamespace" });
		...
		addAnnotation(getURIMatcher_RxPartsGroup(), source, new String[] { "kind", "group", "name", "rxPart:group", "namespace",
		...
		addAnnotation(getURIMatcher_RxParts(), source, new String[] { "kind", "element", "name", "rxPart", "namespace",
				"http://www.eclipse.org/buckminster/Common-1.0", "group", "http://www.eclipse.org/buckminster/Common-1.0#rxPart:group" });
		addAnnotation(getProperties_Properties(), source, new String[] { "name", "property", "namespace", "##targetNamespace", "kind", "element" });
		addAnnotation(getProperties_PropertyElements(), source, new String[] { "name", "propertyElement", "namespace", "##targetNamespace", "kind",
				"element" });
	}

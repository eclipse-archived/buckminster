 ...
 * <ul>
 *   <li>{@link org.eclipse.buckminster.rmap.impl.ProviderImpl#getPattern <em>Pattern</em>}</li>
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Matcher.class) {
			switch (derivedFeatureID) {
				case RmapPackage.PROVIDER__PATTERN: return RmapPackage.MATCHER__PATTERN;
				case RmapPackage.PROVIDER__COMPONENT_TYPES_ATTR: return RmapPackage.MATCHER__COMPONENT_TYPES_ATTR;
				case RmapPackage.PROVIDER__COMPONENT_TYPES: return RmapPackage.MATCHER__COMPONENT_TYPES;
				case RmapPackage.PROVIDER__RESOLUTION_FILTER: return RmapPackage.MATCHER__RESOLUTION_FILTER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Matcher.class) {
			switch (baseFeatureID) {
				case RmapPackage.MATCHER__PATTERN: return RmapPackage.PROVIDER__PATTERN;
				case RmapPackage.MATCHER__COMPONENT_TYPES_ATTR: return RmapPackage.PROVIDER__COMPONENT_TYPES_ATTR;
				case RmapPackage.MATCHER__COMPONENT_TYPES: return RmapPackage.PROVIDER__COMPONENT_TYPES;
				case RmapPackage.MATCHER__RESOLUTION_FILTER: return RmapPackage.PROVIDER__RESOLUTION_FILTER;
				default: return -1;
			}
		}

...
:
(
{ before(grammarAccess.getSelectorAccess().getNameQualifiedNameParserRuleCall_0_0_0()); }
	ruleQualifiedName{ after(grammarAccess.getSelectorAccess().getNameQualifiedNameParserRuleCall_0_0_0()); }
)

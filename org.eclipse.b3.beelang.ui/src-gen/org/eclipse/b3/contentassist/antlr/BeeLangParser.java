			...
			nameMappings = new HashMap<AbstractElement, String>() {
				{
					...
					put(grammarAccess.getWithClauseAccess().getAlternatives_2(), "rule__WithClause__Alternatives_2");
					...
					put(grammarAccess.getRepositoryDeclarationAccess().getAlternatives_0(), "rule__RepositoryDeclaration__Alternatives_0");
					...
					put(grammarAccess.getFunctionAccess().getAlternatives_11(), "rule__Function__Alternatives_11");
					...
					put(grammarAccess.getWithClauseAccess().getGroup_1(), "rule__WithClause__Group_1__0");
					put(grammarAccess.getWithClauseAccess().getGroup_1_2(), "rule__WithClause__Group_1_2__0");
					put(grammarAccess.getWithClauseAccess().getGroup_2_0(), "rule__WithClause__Group_2_0__0");
					...
					put(grammarAccess.getRepositoryDeclarationAccess().getGroup_0_1(), "rule__RepositoryDeclaration__Group_0_1__0");
					...
					put(grammarAccess.getCompoundConcernAccess().getGroup(), "rule__CompoundConcern__Group__0");
					put(grammarAccess.getCompoundConcernAccess().getGroup_1(), "rule__CompoundConcern__Group_1__0");
					...
					put(grammarAccess.getFunctionAccess().getGroup_9_2(), "rule__Function__Group_9_2__0");
					put(grammarAccess.getFunctionAccess().getGroup_10(), "rule__Function__Group_10__0");
					put(grammarAccess.getFunctionAccess().getGroup_10_1(), "rule__Function__Group_10_1__0");
					put(grammarAccess.getFunctionAccess().getGroup_10_1_1(), "rule__Function__Group_10_1_1__0");
					put(grammarAccess.getFunctionAccess().getGroup_11_0(), "rule__Function__Group_11_0__0");
					put(grammarAccess.getMethodAccess().getGroup(), "rule__Method__Group__0");
					put(grammarAccess.getMethodAccess().getGroup_9(), "rule__Method__Group_9__0");
					put(grammarAccess.getMethodAccess().getGroup_9_2(), "rule__Method__Group_9_2__0");
					put(grammarAccess.getMethodAccess().getGroup_10(), "rule__Method__Group_10__0");
					put(grammarAccess.getMethodAccess().getGroup_10_1(), "rule__Method__Group_10_1__0");
					put(grammarAccess.getMethodAccess().getGroup_10_1_1(), "rule__Method__Group_10_1_1__0");
					put(grammarAccess.getMethodAccess().getGroup_11_0(), "rule__Method__Group_11_0__0");
					...
					put(grammarAccess.getLiteralListAccess().getGroup_4(), "rule__LiteralList__Group_4__0");
					put(grammarAccess.getLiteralMapAccess().getGroup(), "rule__LiteralMap__Group__0");
					put(grammarAccess.getLiteralMapAccess().getGroup_2(), "rule__LiteralMap__Group_2__0");
					put(grammarAccess.getLiteralMapAccess().getGroup_2_1(), "rule__LiteralMap__Group_2_1__0");
					put(grammarAccess.getLiteralMapAccess().getGroup_4(), "rule__LiteralMap__Group_4__0");
					...
					put(grammarAccess.getWithClauseAccess().getReferencesAssignment_1_1(), "rule__WithClause__ReferencesAssignment_1_1");
					put(grammarAccess.getWithClauseAccess().getReferencesAssignment_1_2_1(), "rule__WithClause__ReferencesAssignment_1_2_1");
					put(grammarAccess.getWithClauseAccess().getPropertiesAssignment_2_0_1(), "rule__WithClause__PropertiesAssignment_2_0_1");
					put(grammarAccess.getWithClauseAccess().getConcernAssignment_2_1_1(), "rule__WithClause__ConcernAssignment_2_1_1");
					...
					put(grammarAccess.getRepositoryDeclarationAccess().getLocationAssignment_0_0(), "rule__RepositoryDeclaration__LocationAssignment_0_0");
					put(grammarAccess.getRepositoryDeclarationAccess().getResolverClassAssignment_0_1_1(), "rule__RepositoryDeclaration__ResolverClassAssignment_0_1_1");
					put(grammarAccess.getRepositoryDeclarationAccess().getContextAssignment_1(), "rule__RepositoryDeclaration__ContextAssignment_1");
					...
					put(grammarAccess.getCompoundConcernAccess().getAdviceAssignment_1_0(), "rule__CompoundConcern__AdviceAssignment_1_0");
					...
					put(grammarAccess.getFunctionAccess().getTypeParamsAssignment_9_1(), "rule__Function__TypeParamsAssignment_9_1");
					put(grammarAccess.getFunctionAccess().getTypeParamsAssignment_9_2_1(), "rule__Function__TypeParamsAssignment_9_2_1");
					put(grammarAccess.getFunctionAccess().getParamsAssignment_10_1_0(), "rule__Function__ParamsAssignment_10_1_0");
					put(grammarAccess.getFunctionAccess().getParamsAssignment_10_1_1_1(), "rule__Function__ParamsAssignment_10_1_1_1");
					put(grammarAccess.getFunctionAccess().getBodyAssignment_11_0_1(), "rule__Function__BodyAssignment_11_0_1");
					put(grammarAccess.getFunctionAccess().getBodyAssignment_11_1(), "rule__Function__BodyAssignment_11_1");
					...
					put(grammarAccess.getMethodAccess().getExecutionModeAssignment_3(), "rule__Method__ExecutionModeAssignment_3");
					put(grammarAccess.getMethodAccess().getFinalAssignment_4(), "rule__Method__FinalAssignment_4");
					put(grammarAccess.getMethodAccess().getCachedAssignment_5(), "rule__Method__CachedAssignment_5");
					put(grammarAccess.getMethodAccess().getTypeAssignment_7(), "rule__Method__TypeAssignment_7");
					put(grammarAccess.getMethodAccess().getNameAssignment_8(), "rule__Method__NameAssignment_8");
					put(grammarAccess.getMethodAccess().getTypeParamsAssignment_9_1(), "rule__Method__TypeParamsAssignment_9_1");
					put(grammarAccess.getMethodAccess().getTypeParamsAssignment_9_2_1(), "rule__Method__TypeParamsAssignment_9_2_1");
					put(grammarAccess.getMethodAccess().getParamsAssignment_10_1_0(), "rule__Method__ParamsAssignment_10_1_0");
					put(grammarAccess.getMethodAccess().getParamsAssignment_10_1_1_1(), "rule__Method__ParamsAssignment_10_1_1_1");
					put(grammarAccess.getMethodAccess().getBodyAssignment_11_0_1(), "rule__Method__BodyAssignment_11_0_1");
					put(grammarAccess.getMethodAccess().getBodyAssignment_11_1(), "rule__Method__BodyAssignment_11_1");
					...
					put(grammarAccess.getLiteralListAccess().getElementAssignment_2_0(), "rule__LiteralList__ElementAssignment_2_0");
					put(grammarAccess.getLiteralListAccess().getElementAssignment_2_1_1(), "rule__LiteralList__ElementAssignment_2_1_1");
					put(grammarAccess.getLiteralListAccess().getTypeAssignment_4_1(), "rule__LiteralList__TypeAssignment_4_1");
					put(grammarAccess.getLiteralMapAccess().getFeaturesAssignment_2_0(), "rule__LiteralMap__FeaturesAssignment_2_0");
					put(grammarAccess.getLiteralMapAccess().getFeaturesAssignment_2_1_1(), "rule__LiteralMap__FeaturesAssignment_2_1_1");
					put(grammarAccess.getLiteralMapAccess().getKeyTypeAssignment_4_1(), "rule__LiteralMap__KeyTypeAssignment_4_1");
					put(grammarAccess.getLiteralMapAccess().getValTypeAssignment_4_3(), "rule__LiteralMap__ValTypeAssignment_4_3");

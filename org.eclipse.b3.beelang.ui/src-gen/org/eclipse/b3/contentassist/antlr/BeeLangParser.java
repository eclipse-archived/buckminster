			...
			nameMappings = new HashMap<AbstractElement, String>() {
				{
					...
					put(grammarAccess.getGroupAccess().getExecutionModeAssignment_1(), "rule__Group__ExecutionModeAssignment_1");
					...
					put(grammarAccess.getActionAccess().getExecutionModeAssignment_1(), "rule__Action__ExecutionModeAssignment_1");
					put(grammarAccess.getActionAccess().getProvidedCapabilitiesAssignment_4_1(), "rule__Action__ProvidedCapabilitiesAssignment_4_1");
					put(grammarAccess.getActionAccess().getProvidedCapabilitiesAssignment_4_2_1(), "rule__Action__ProvidedCapabilitiesAssignment_4_2_1");
					put(grammarAccess.getActionAccess().getAssertsAssignment_5(), "rule__Action__AssertsAssignment_5");
					put(grammarAccess.getActionAccess().getAssertsAssignment_6(), "rule__Action__AssertsAssignment_6");
					put(grammarAccess.getActionAccess().getPropertiesAssignment_8_1(), "rule__Action__PropertiesAssignment_8_1");
					put(grammarAccess.getActionAccess().getAdviceAssignment_9(), "rule__Action__AdviceAssignment_9");
					put(grammarAccess.getActionAccess().getResultGroupAssignment_10(), "rule__Action__ResultGroupAssignment_10");
					put(grammarAccess.getActionAccess().getLayoutAssignment_11(), "rule__Action__LayoutAssignment_11");
					put(grammarAccess.getActionAccess().getStatementsAssignment_12(), "rule__Action__StatementsAssignment_12");
					...
					put(grammarAccess.getForStatementAccess().getCondAssignment_5(), "rule__ForStatement__CondAssignment_5");
					put(grammarAccess.getForStatementAccess().getIterateAssignment_7(), "rule__ForStatement__IterateAssignment_7");
					put(grammarAccess.getForStatementAccess().getBodyAssignment_9(), "rule__ForStatement__BodyAssignment_9");
					...
					put(grammarAccess.getVarExpressionAccess().getValueAssignment_1_3(), "rule__VarExpression__ValueAssignment_1_3");

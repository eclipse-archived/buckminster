...
{
	/**
	 * The default value of the '{@link #getLimit() <em>Limit</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getLimit()
	 * @generated
	...
	public void setStyle(SplitType newStyle)
	{
		...
		styleESet = true;
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.SPLIT__STYLE, oldStyle, style,
					!oldStyleESet));
	}
	...
	public void unsetStyle()
	{
		...
		styleESet = false;
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CommonPackage.SPLIT__STYLE, oldStyle,

...
public class PropertyElementImpl extends PropertyImpl implements PropertyElement
{
	...
	/**
	 * The cached value of the '{@link #getToLower() <em>To Lower</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getToLower()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getToUpper() <em>To Upper</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getToUpper()
	 * @generated
	...
	public NotificationChain basicSetConstant(Constant newConstant, NotificationChain msgs)
	{
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonPackage.PROPERTY_ELEMENT__CONSTANT, oldConstant, newConstant);
	...
	public NotificationChain basicSetFormat(Format newFormat, NotificationChain msgs)
	{
		...
		format = newFormat;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonPackage.PROPERTY_ELEMENT__FORMAT, oldFormat, newFormat);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public NotificationChain basicSetPropertyRef(PropertyRef newPropertyRef, NotificationChain msgs)
	{
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonPackage.PROPERTY_ELEMENT__PROPERTY_REF, oldPropertyRef, newPropertyRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public NotificationChain basicSetReplace(Replace newReplace, NotificationChain msgs)
	{
		...
		replace = newReplace;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonPackage.PROPERTY_ELEMENT__REPLACE, oldReplace, newReplace);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public NotificationChain basicSetToLower(ToLower newToLower, NotificationChain msgs)
	{
		...
		toLower = newToLower;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonPackage.PROPERTY_ELEMENT__TO_LOWER, oldToLower, newToLower);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public NotificationChain basicSetToUpper(ToUpper newToUpper, NotificationChain msgs)
	{
		...
		toUpper = newToUpper;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonPackage.PROPERTY_ELEMENT__TO_UPPER, oldToUpper, newToUpper);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConstant(Constant newConstant)
	{
		if (newConstant != constant) {
			...
			if (constant != null)
				msgs = ((InternalEObject)constant).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CommonPackage.PROPERTY_ELEMENT__CONSTANT, null, msgs);
			if (newConstant != null)
				msgs = ((InternalEObject)newConstant).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.PROPERTY_ELEMENT__CONSTANT, null, msgs);
	...
	public void setPropertyRef(PropertyRef newPropertyRef)
	{
		if (newPropertyRef != propertyRef) {
			NotificationChain msgs = null;
			if (propertyRef != null)
				msgs = ((InternalEObject)propertyRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CommonPackage.PROPERTY_ELEMENT__PROPERTY_REF, null, msgs);
			if (newPropertyRef != null)
				msgs = ((InternalEObject)newPropertyRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.PROPERTY_ELEMENT__PROPERTY_REF, null, msgs);
	...
	public void setToLower(ToLower newToLower)
	{
		if (newToLower != toLower) {
			NotificationChain msgs = null;
			if (toLower != null)
				msgs = ((InternalEObject)toLower).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CommonPackage.PROPERTY_ELEMENT__TO_LOWER, null, msgs);
			if (newToLower != null)
				msgs = ((InternalEObject)newToLower).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.PROPERTY_ELEMENT__TO_LOWER, null, msgs);
	...
	public void setToUpper(ToUpper newToUpper)
	{
		if (newToUpper != toUpper) {
			NotificationChain msgs = null;
			if (toUpper != null)
				msgs = ((InternalEObject)toUpper).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CommonPackage.PROPERTY_ELEMENT__TO_UPPER, null, msgs);
			if (newToUpper != null)
				msgs = ((InternalEObject)newToUpper).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.PROPERTY_ELEMENT__TO_UPPER, null, msgs);

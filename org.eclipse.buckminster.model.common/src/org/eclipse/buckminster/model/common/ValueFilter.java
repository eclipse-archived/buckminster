 ...
 * @generated
 */
public interface ValueFilter extends EObject
{
	/**
	 * Returns the value of the '<em><b>Constants</b></em>' containment reference list. The list contents are of type
	 * {@link org.eclipse.buckminster.model.common.Constant}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model containment="true" extendedMetaData="namespace='##targetNamespace' kind='element' name='constant'"
	 * @generated
	 */
	EList<Constant> getConstants();

	/**
	 * Returns the value of the '<em><b>Formats</b></em>' containment reference list. The list contents are of type
	 ...
	 * @model containment="true" extendedMetaData="namespace='##targetNamespace' kind='element' name='format'"
	 * @generated
	 */
	EList<Format> getFormats();

	/**
	 * Returns the value of the '<em><b>Property Refs</b></em>' containment reference list. The list contents are of
	 * type {@link org.eclipse.buckminster.model.common.PropertyRef}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model containment="true" extendedMetaData="namespace='##targetNamespace' kind='element' name='propertyRef'"
	 * @generated
	 */
	EList<PropertyRef> getPropertyRefs();

	/**
	 * Returns the value of the '<em><b>Replacements</b></em>' containment reference list. The list contents are of type
	 ...
	 * @model containment="true" extendedMetaData="namespace='##targetNamespace' kind='element' name='replace'"
	 * @generated
	 */
	EList<Replace> getReplacements();

	/**
	 * Returns the value of the '<em><b>Splits</b></em>' containment reference list. The list contents are of type
	 ...
	 * @model containment="true" extendedMetaData="namespace='##targetNamespace' kind='element' name='split'"
	 * @generated
	 */
	EList<Split> getSplits();

	/**
	 * Returns the value of the '<em><b>To Lowers</b></em>' containment reference list. The list contents are of type
	 ...
	 * @model containment="true" extendedMetaData="namespace='##targetNamespace' kind='element' name='toLower'"
	 * @generated
	 */
	EList<ToLower> getToLowers();

	/**
	 * Returns the value of the '<em><b>To Uppers</b></em>' containment reference list. The list contents are of type
	 ...
	 * @model containment="true" extendedMetaData="namespace='##targetNamespace' kind='element' name='toUpper'"
	 * @generated
	 */

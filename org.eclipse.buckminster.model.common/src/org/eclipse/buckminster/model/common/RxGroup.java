...
{
	/**
	 * Returns the value of the '<em><b>Rx Part</b></em>' containment reference list. The list contents are of type
	...
	/**
	 * Returns the value of the '<em><b>Rx Parts Group</b></em>' attribute list. The list contents are of type

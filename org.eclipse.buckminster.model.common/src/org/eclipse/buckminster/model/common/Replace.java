...
{
	/**
	 * Returns the value of the '<em><b>Matches</b></em>' containment reference list. The list contents are of type
	...
	/**
	 * Returns the value of the '<em><b>Quote Pattern</b></em>' attribute. The default value is <code>"false"</code>.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model default="false" unsettable="true" extendedMetaData="kind='attribute'"
	 * @generated
	 */
	boolean isQuotePattern();

	/**
	 * Returns whether the value of the '{@link org.eclipse.buckminster.model.common.Replace#isQuotePattern
	 * <em>Quote Pattern</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.model.common.Replace#getPattern <em>Pattern</em>}'
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.model.common.Replace#isQuotePattern <em>Quote Pattern</em>}
	 * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.buckminster.model.common.Replace#getReplacement <em>Replacement</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Unsets the value of the '{@link org.eclipse.buckminster.model.common.Replace#isQuotePattern
	 * <em>Quote Pattern</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetQuotePattern()
	 * @see #isQuotePattern()
	 * @see #setQuotePattern(boolean)

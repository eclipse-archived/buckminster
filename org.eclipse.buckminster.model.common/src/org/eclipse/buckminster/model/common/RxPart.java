...
public interface RxPart extends BObject {
	 ...
	 * 
	 * Denotes if this part a capturing group or not. The match for a named part
	 * can be used in replacement patterns.
	 * 
	 * <!-- end-model-doc -->
	 * 
	 ...
	 * 
	 * Denotes if this part is optional (must be matched) or not. The top
	 * element of a regexp can not be optional.
	 * 
	 * <!-- end-model-doc -->
	 * 

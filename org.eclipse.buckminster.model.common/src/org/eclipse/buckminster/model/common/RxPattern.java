...
public interface RxPattern extends RxPart {
	 ...
	 * regular expression for this group (excluding parenthesis for the group
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The
	 * quoted prefix of the pattern. Not included in the capture <!--
	 * end-model-doc -->
	 * 
	 ...
	 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The
	 * quoted suffix of the pattern. Not included in the capture <!--
	 * end-model-doc -->
	 * 

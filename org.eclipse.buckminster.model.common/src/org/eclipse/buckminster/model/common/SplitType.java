...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration ' <em><b>Split Type</b></em>', and
 * utility methods for working with them. <!-- end-user-doc --> <!-- begin-model-doc --> A split can be done using a
 * delimiter or a pattern containing capturing groups. In case of delimiter it can be quoted or not quoted. <!--
 * end-model-doc -->
 * 

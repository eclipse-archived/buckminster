...
{
	/**
	 * Close the given stream. Catch and log any {@link IOException} that might be thrown. This
	 * method is suitable for use in finally block since you don't want an exception that is
	 * thrown there to shadow other exceptions thrown from the try block.
	 * 
	 * @param plugin 
	...
	/**
	 * Delete the file or folder given in <code>fileOrFolder</code>. A folder will be cleaned out (recursively)
	...
	/**
	 * Open the input stream of the given file store and exposes any FileNotFoundException
	 * that hides in a potential CoreException.
	 * @param fs The file store to open.
	 * @param monitor
